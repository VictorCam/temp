...
<template>
  <header class="z1 b-b b-solid dark:b-dark-200 b-light-900">
    <div v-if="isLoggingOut" class="bg-base-100 op50 fixed z-1 inset-0">
      <div class="i-svg-spinners-bars-rotate-fade p3 center"></div>
    </div>
    <div class="sm:mx3 flex items-center gap3 p3 h6">
      ...
      <nav
        ...
        <div class="relative inline-block group">
          ...
          <div
            class="absolute left-0 <sm:bottom-full w-48 border rounded shadow-md opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-200 ease-out">
            <a href="#" class="wfull no-underline cursor-pointer block px-4 py-2 bg-base-100 b-none flex gap2">English
              <div class="i-ic-baseline-keyboard-arrow-right"></div>
            </a>
            <a href="#" class="wfull no-underline cursor-pointer block px-4 py-2 bg-base-100 b-none flex gap2">Spanish
              <div class="i-ic-baseline-keyboard-arrow-right"></div>
            </a>
          </div>
        </div>

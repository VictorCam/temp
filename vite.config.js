...
export default defineConfig({
  plugins: [
    ...
    UnoCSS({
      ...
      shortcuts: {
        'animate-bg-icon': 'animate-bg mask-size-[auto] mask-position-[center] mask-repeat-[repeat] animate-iteration-infinite absolute rotate-z-35',
        ...
        'c-invert-100': 'c-black dark:c-light',
        'bg-invert-100': 'bg-dark-900 dark:bg-light-100',
